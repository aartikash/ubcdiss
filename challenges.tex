...
There are multiple possible approaches such as SMT \karthik{Did we expand this earlier?} solvers, symbolic execution and MILP.
...
\begin{enumerate}
	...
	\karthik{Check reference}  with 50 neurons each. 
