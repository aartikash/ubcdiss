...
They are increasingly being deployed for applications \cite{10.1145/2038642.2038685}\cite{10.1145/1837274.1837463} \cite{6051465} such as medical devices (e.g., insulin pumps and robotic surgery equipment), \karthik{You mean failures of, I hope ?} which could be life threatening, and hence need high reliability. 
...
Some targeted attacks demonstrated in these systems also utilized the glitches in the software \karthik{What's a software glitch ? Is it just a bug ?} to induce attacks without getting detected \cite{242054}. 
...
This can be conducted by causing \karthik{Read your drafts !}
...
However, a motivated attacker can figure out how to conduct such attacks in a \ac{DNN}. \karthik{as we demonstrate in this thesis}. 
...
This work takes a first step towards preventing such attacks by introducing a technique to synthesize such attacks. \karthik{I made it less dramatic}
...
\karthik{Only the first one is a result - the others are just repetition of the contributions, so remove them.}.
\begin{enumerate}
	\item We exposed a new set of vulnerabilities in \ac{DNN} based systems. 
	 We find ~7000, ~20, ~40 successful \ac{RFDIA} for \ac{APS}, \ac{HCAS} and \ac{ACAS-Xu} in a reasonable amount of time. \karthik{How long - be precise?}
