...
\begin{enumerate}
	...
	\item The \ac{DNN} contains ReLU as its activation function. \karthik{This is not a capability of the attacker, but rather is an assumption we make. So move it to a separate paragraph.}
